...
% ****************************************************************************************************
\newcommand{\myTitle}{Question Answering on the textbook "Health Information Systems" using Large Language Models\xspace}
\newcommand{\mySubtitle}{\xspace}
\newcommand{\myDegree}{\xspace}
\newcommand{\myName}{Simon Künzig\xspace}
\newcommand{\mybirthday}{18.12.1993}
\newcommand{\mybirthtown}{Hannover}
\newcommand{\mybirthcountry}{Germany}
\newcommand{\myProf}{Dr. Konrad Höffner\xspace}
...
%\newcommand{\myFaculty}{Faculty of Mathematics and computer science\xspace}
%\newcommand{\myDepartment}{Institute for computer science\xspace}
...
\newcommand{\myTime}{06.07.2026\xspace} 
...
% ****************************************************************************************************
\usepackage{listings}
% Legacy listings setup kept only as reference; active setup is in the custom block below.
...
\lstset{language=[LaTeX]Tex,%C++,
  ...
  numbersep=8pt,
  showstringspaces=false,
  prebreak=\raisebox{0ex}[0ex][0ex]{\ensuremath{\rightarrow}},
  breaklines=true,
  breakatwhitespace=true,
  %frameround=ftff,
  %frame=single,
  belowcaptionskip=.75\baselineskip,
  %frame=L
  moredelim=**[is][\bfseries\color{RoyalBlue}]{!}{!}
}
% 

% --- YAML definition for listings ---
\definecolor{dkgreen}{rgb}{0,0.6,0}
\definecolor{gray}{rgb}{0.5,0.5,0.5}
\definecolor{mauve}{rgb}{0.58,0,0.82}
\definecolor{lightorange}{rgb}{1.0, 0.85, 0.7}
\definecolor{softblue}{rgb}{0.6, 0.75, 0.9}

\lstdefinelanguage{YAML}{
  keywords={true, false, null, on, off},
  keywordstyle=\color{softblue},
  basicstyle=\ttfamily\footnotesize,
  ndkeywords={services, app, volumes}, % Add your own keywords here
...
\lstdefinelanguage{json}{
  ...
  literate={"}{{\textcolor{black}{"}}}1
           {:}{{\textcolor{softblue}{:}}}1
           {,}{{\textcolor{gray}{,}}}1
           {[}{{\textcolor{lightorange}{[}}}1
           {]}{{\textcolor{lightorange}{]}}}1
           {\{}{{\textcolor{lightorange}{\{}}}1
           {\}}{{\textcolor{lightorange}{\}}}}1,
}
\definecolor{lightgray}{rgb}{0.8, 0.8, 0.8}  % General symbols and comments
\definecolor{softblue}{rgb}{0.6, 0.75, 0.9}  % For Headers
\definecolor{mintgreen}{rgb}{0.7, 0.9, 0.7}  % For Lists/Blockquotes
\definecolor{softred}{rgb}{0.95, 0.8, 0.8}   % For Emphasis (** or __)
\definecolor{lightorange}{rgb}{1.0, 0.85, 0.7} % For Links/Images
\definecolor{lavender}{rgb}{0.8, 0.75, 0.95} % For Code/Keywords

\lstdefinelanguage{Markdown}{
  % 1. Basic Style and Frame 
  basicstyle=\ttfamily\footnotesize, 
  numbers=left, 
  numberstyle=\tiny\color{gray}, 
  stepnumber=1, 
  ...
  literate=
    ...
    {\#\#\#\#}{{\textcolor{softblue}{\#\#\#\#}}}4 
    %
    {*}{{\textcolor{mintgreen}{*}}}1 
    {-}{{\textcolor{mintgreen}{-}}}1 
    {>}{{\textcolor{mintgreen}{>}}}1 
    {<}{{\textcolor{mintgreen}{<}}}1 
    %
    {**}{{\textcolor{softred}{**}}}2 
    {__}{{\textcolor{softred}{\_\_}}}2 
    %
    {[}{{\textcolor{lightorange}{[}}}1 
    {]}{{\textcolor{lightorange}{]}}}1 
    {(}{{\textcolor{lightorange}{(}}}1 
  ...
  keywordstyle=\color{lavender}, % Removed \bfseries
}[keywords, comments, strings]
\usepackage{cleveref}
\usepackage{cuted}
