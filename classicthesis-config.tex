...
% ****************************************************************************************************
\newcommand{\myTitle}{Evaluating Language Models for Knowledge Retrieval from the Textbook "Health Information System": A Reproducible Benchmarking Approach in a Resource-constrained Environment\xspace}
...
\lstdefinelanguage{Markdown}{
  ...
  keywordstyle=\color{lavender}, % Removed \bfseries for slight highlighting
}[keywords, comments, strings]
\usepackage{cleveref}
\usepackage{cuted}
