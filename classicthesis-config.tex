...
% ****************************************************************************************************
\newcommand{\myTitle}{Evaluating Large Language Models for Knowledge Retrieval from the Textbook "Health Information System": A Reproducible Benchmarking Approach in a Resource-constrained Environment\xspace}
...
\@ifpackageloaded{babel}%
  {%
    \addto\extrasamerican{%
     ...
     %\renewcommand*{\crefname{section}{Section}{Sections}} Die beiden haben nicht funktoniert
     %\renewcommand*{\Crefname{section}{Section}{Sections}} 
   % \addto\extrasngerman{%
