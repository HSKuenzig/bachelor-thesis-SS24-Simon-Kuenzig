...
Individually fine-tuning an open-source \ac{llm}, such as Llama-2, have demonstrated improved performance over untrained versions, but still show significant performance differences compared to more capable language models, such as OpenAI's GPT-4 \citep{Paul_Keller}.
