...
\begin{itemize}
 ...
 \item Task for goal G2
    \begin{itemize}
          \item Task A2.2: Evaluation of selected language models in this thesis with regard to their ability to answer questions correctly applying the same criteria as \citet{Paul_Keller}.
          \item Task A2.3:
