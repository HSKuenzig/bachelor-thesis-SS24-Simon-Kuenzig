...
\todo{Bitte diesen Abschnitt noch nachschärfen, momentan schweift es mir noch zu weit ab in Teile, die für uns nicht so relevant sind. --> Hier habe ich einiges ruasgeworfen und es auf die essentiellen Dinge runter gebrochen. Würdest du es so lassen? }
\todo{Achtung: data und information nicht austauschbar verwendbar --> Ich habe nochmal versucht, die Begriffe im richtigen Kontext zu verwenden, gerne nochmal drüber gehen, danke }
...
Da hier ein Einblick in das Thema erfolgt, erscheint es mir als explizites Beispiel im Zusammenhang zum vorhergehenden Satz passend. Eine Relevanz in Bezug auf das darauffolgenden Ziel ist fraglich, aber im Abschnitt "Subject Matter" als Information angebracht? }
