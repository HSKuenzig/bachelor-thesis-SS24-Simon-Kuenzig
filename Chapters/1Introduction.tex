...
However, still showing significant performance differences compared to more powerful language models, such as OpenAI's GPT-4 \citep{Paul_Keller}.
In conclusion, \citet{Paul_Keller} suggests that more capable language models should be used to improve and overcome these deficiencies in knowledge extraction and processing.
...
Thus, the key challenge is to provde the efficient and intuitive \ac{llm}-based knowledge retrieval approaches for \citet{bb2} as a knowledge base with an automatic and systematic evaluation of the generated results to allow objective comparison of different retrieval methods.
...
\begin{itemize}
  \item goal G1:\\
    A reproducible application based on selected language models for automatic, efficient and intuitive knowledge extraction from \citet{bb2}.
