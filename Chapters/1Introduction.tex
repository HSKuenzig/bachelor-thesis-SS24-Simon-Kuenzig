...
\begin{itemize}
 % \item \textbf{Problem 1:} \ac{llm}-based retrieval approaches for \citet{bb2} as a knowledge base lack a standardised and reproducible evaluation framework.
  \item \textbf{Problem 1:} \todo{Da Studenten weniger das Framework benötigen, als die Möglichkeit eines objektiven Vergleichs und darauf basierend eines Assessments der Anwendungen.}\ac{llm}-based knowledge retrieval for \citet{bb2} lacks a standardized and reproducible evaluation, hindering objective assessment and comparison of its capabilities.
\end{itemize}
%
