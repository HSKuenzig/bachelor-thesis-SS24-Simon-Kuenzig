...
\begin{itemize}
  ...
  \item \textbf{Problem 2:} Resource constraints prevent students and teachers from using advanced language models for individual initial training and fine-tuning effectively.
\end{itemize}
%
...
In \citet{Paul_Keller}, it was shown that with training and fine-tuning these \ac{llm}'s can provide more comprehensible responses with an improved accuracy in explicit, limited reference to \citet{bb2}, as \enquote{[$\dots$]a MacroF1 value of \num{0.45} and answers \num{12} of \num{22} questions with at least one correct answer[$\dots$]}\citep{Paul_Keller} was achieved.
...
Such improvement may be reached through either the use of large scale hardware to fully exploit the capabilities of larger \ac{llm}-models with more parameters or by expanding the models with further techniques in order to reduce the occurrence of incorrect answers.\\
%
