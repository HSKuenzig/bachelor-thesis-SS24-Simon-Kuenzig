...
In \citet{Paul_Keller}, it was shown that with training and fine-tuning an open-source \ac{llm} was able to outperform its untrained version and could provide more comprehensible responses with an improved accuracy in explicit, limited reference to \citet{bb2}.
