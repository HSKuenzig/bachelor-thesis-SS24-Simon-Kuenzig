...
In \citet{kinikogluI2025GPTGemini}, the performance of four of today's most advanced models, \textit{ChatGPT-4o} (San Francisco, CA: OpenAI), \textit{ChatGPT-o1}, Gemini 1.5 Pro (Mountain View, CA: Google LLC) and \textit{Gemini 2.0 Advanced}, on the Turkish Dental Specialist Examination (DUS) for 2020 and 2021 was analyzed.
...
%
The \textit{overall accuracy} of \textit{ChatGPT-o1} and \textit{Gemini 2.0 Advanced} remained above $93$ for the evaluated exams, outperforming the less advanced models \textit{ChatGPT-4o} and \textit{Gemini 1.5 Pro}.
...
%
Despite these improvements, challenges remain to fully leveraging extended context window models. 
...
Their ability to process entire academic texts directly, without the need for pre-processing or fine-tuning, represents a potential solution to the challenges outlined in \cref{sec:problem statement}.

\section{Retrieval-Augmented Generation for QA}
\subsection{Question Answering}

Traditionally, data, information and knowledge were managed using conventional data records with descriptive fields and sortable characteristics. 
However, the constantly growing volume of data and the ongoing need for fast data access have led to the development of new types of data structures and extraction processes. Modern \ac{qa} systems are an example of such advances. 
They enable users to retrieve data, information and knowledge from large databases in the shortest possible time with the help of various and constantly evolving technical approaches.
The storage of data, information and knowledge in the form of graphs (e.g. knowledge graphs and ontologies) makes it possible to graphically represent relationships between stored entities and to be recognized as such by the retrieval system and made available to the user upon request.
The potential of creating and building appliactions for \ac{qa} upon an ontology as knowledge base was demonstrated by the \ac{snik} project. 
The development of knowledge retrieval system, such as \ac{QA}, for the \ac{snik}-ontology lead to recurring problems associated with \ac{sqa} using knowledge graphs and ontologies, which were investigated and described in 
\citet{Hoffner2016QASurvey}.
%%%
